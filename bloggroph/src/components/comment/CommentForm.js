...
const CommentForm = ({slug}) => {
    ...
    return (
        <Grid container sx={{backgroundColor:"rgba(104, 142, 250, 0.1)",boxShadow: "rgba(0, 0, 0, 0.1) 0px 4px 12px",direction:"rtl",
             borderRadius: 4,
             py: 1,
             mt: 5
             }}
        >
            <Grid item xs={12} m={2}>
                <Typography component="p" variant="h6" color="white" fontWeight={700}>فرم ارسال کامنت</Typography>
            </Grid>
            <Grid item xs={12} m={2}>
                <TextField
                      label="نام کاربری"
